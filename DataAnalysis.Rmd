...
c2<-glmmTMB(pollen_stigma ~ treat+(1|bird_id), data=tri, family=nbinom2)
c<-glmmTMB(pollen_stigma ~ treatment*owner_pollen, data=tri, family=nbinom2)
...
bbmle::AICtab(c,c0,c1,c2, c3, c4,c5,c6,c7,c8, base=T, 
       weights=T) %>% 
  kable(digits=2)
```
